...
- **Navigation:** four section links remain the top level. The review branch now gives a resolved mobile conversation a focused header without the global dock; the inbox and browsing pages retain their labeled navigation. Test the actual 320px and 390px layouts, desktop breakpoint, browser back, long content, and bottom clearance. The mobile keyboard must not hide a focused composer or its action. See the [chat-space audit](../audits/2026-09-07-mobile-chat-space.md) for measured evidence and outstanding real-device checks.
